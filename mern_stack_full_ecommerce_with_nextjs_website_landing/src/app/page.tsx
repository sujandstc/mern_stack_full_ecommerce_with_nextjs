		...
		<>
			...
			<section id='products' className=' mt-10 container mx-auto'>
				<div className='2xl:mx-28  lg:mx-4 mx-2 '>
					<MainPageHeading heading='Our Products' description='Check out our latest products.' />
					<div className='mt-10 grid grid-cols-12 gap-4'>
						{response.data.data.slice(0, 3).map((product: any, index: any) => (
					...
					<div className=' flex justify-end mt-10'>
						<Link href={'/products'} className='flex-row flex mt-5 gap-[-20px] items-center'>
							<div className='font-bold text-[30px]'> Explore </div>
							<FaChevronRight className='mr-[-20px]' size={30} /> <FaChevronRight className='mr-[-20px]' size={40} />
			...
			<section id='top_products' className='container mt-10 mx-auto'>
				<div className='2xl:mx-28  lg:mx-4 mx-2 '>
					{' '}
					<MainPageHeading heading='Top Products' description='Check out our top products.' />
					<div className='mt-10 grid grid-cols-12 gap-4'>
						{response.data.data.slice(0, 3).map((product: any, index: any) => (
							<div key={index} className='lg:col-span-4 col-span-12'>
								<ProductsDisplayComponent product={product} />
