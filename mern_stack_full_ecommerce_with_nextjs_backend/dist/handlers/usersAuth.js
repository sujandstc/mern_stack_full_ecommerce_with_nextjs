...
const usersAuth = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const jwtVerify = jsonwebtoken_1.default.verify(accessToken, process.env.jwt_secret_user);
