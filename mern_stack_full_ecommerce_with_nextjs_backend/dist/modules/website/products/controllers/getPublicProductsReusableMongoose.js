...
const getPublicProductsReusableMongoose = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const queryData = (0, reusableMongoose_1.default)({
        // kun model bata data fing garne ya lekhne...
        mongooseQuery: products_model_1.default.find({}),
        // Query pass garne..
...
exports.default = getPublicProductsReusableMongoose;
