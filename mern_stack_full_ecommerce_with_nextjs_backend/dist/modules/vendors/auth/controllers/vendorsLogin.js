...
const vendorsLogin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const getUser = yield vendors_model_1.default
        .findOne({
        email: email,
    })
        .select("+password");
    if (!getUser)
        throw "This vendor email doesnot exist!";
